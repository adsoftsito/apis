...
4. Instalar [docker](https://docs.docker.com/engine/install/centos/)
5. Lectura [introduccion a docker](https://github.com/adsoftsito/web/blob/main/w1/docker_intro.pdf)
6. Realizar [DockerLab](https://github.com/adsoftsito/web/blob/main/w1/dockerlab.pdf)
7. Registrarse en [Docker Hub](https://hub.docker.com/)
8. Subir imagen de nodejs a Docker Hub (Punto 5 dockerlab)
